---
title: "Fetching Pokémon Data Concurrently in Go"
...
By splitting apart the work across multiple Goroutines, we can split the work into different smaller tasks, which is overkill in the best way for a simple task like fetching data from an API. Check out the repo [here](https://github.com/bduckdev/fetch-pokemon). Follow my [LinkedIn](https://linkedin.com/in/bduckdev). If you want to reach me, shoot me an email at <u>brennantduck@gmail.com</u>
